      ...
      <div className="flex-1 overflow-y-auto px-6 py-8 flex flex-col items-center">
        ...
        <div className="bg-gray-50 border border-gray-100 rounded-[2rem] p-6 w-full max-w-md shadow-sm space-y-4 text-gray-650 text-sm leading-relaxed">
          <p className="font-bold text-slate-800 text-base border-b border-gray-200/60 pb-2">
            Des services sûrs, traçables et réactifs
          </p>
          <p>
            Cette section présentera bientôt tous les droits des clients, notre charte qualité, la protection de vos données et le fonctionnement du service client de <span className="font-bold text-orange-500">FILANT°225</span>.
          </p>
          <p>
            Que vous ayez besoin d'une intervention rapide de plomberie, d'un électricien réactif, d'obtenir des équipements ou de trouver un bien locatif de choix, nous veillons au bon déroulement de chaque prestation.
          </p>
          <div className="p-3 bg-white border border-gray-100 rounded-xl flex items-start gap-3 mt-4">
            <span className="text-xl">ℹ️</span>
            <p className="text-xs text-gray-500 font-medium">
              Notre charte d'utilisation et de confiance client détaillée sera accessible ici très prochainement pour une sécurité absolue.
            </p>
          </div>
        </div>
      </div>
