...
const SpeakerIcon: React.FC<{ text: string; className?: string }> = ({ text, className }) => {
  ...
  return (
    <button 
        ...
        className={`p-1.5 rounded-full transition-all duration-200 hover:bg-black/5 dark:hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-orange-400 ${className}`}
        title="Lire le texte"
    >
